...
use crate::ownedmidihandler::OwnedMidiHandler;
...
use audioprocessor::PwAudioProcessor;
use supportedformats::PwSupportedFormats;

pub struct PwContext {
    sample_rate: u32,
    bufsize: usize,
    fixed: bool,
    voice_mode: crate::VoiceMode,
}
...
impl PwMidiHandler {
    ...
    fn get_tuning(&self) -> (crate::Tuning, crate::Tuning) {
...
impl crate::MidiHandler for PwMidiHandler {
...
impl ContextReader for PwContext {
    ...
    fn voice_mode(&self) -> crate::VoiceMode {
        self.voice_mode
    }
}
...
fn pw_audio(
    ...
    let props = properties! {
        *pw::keys::APP_NAME => crate::NAME,
        *pw::keys::APP_VERSION => crate::VERSION,
        *pw::keys::MEDIA_CATEGORY => "Playback",
        *pw::keys::MEDIA_ROLE => "DSP",
        *pw::keys::MEDIA_TYPE => "Audio",
        *pw::keys::NODE_LATENCY => PwSupportedFormats::LATENCY_STR,
    };
    let stream =
        pw::stream::Stream::new(&core, crate::NAME, props).expect("Failed to create stream");
